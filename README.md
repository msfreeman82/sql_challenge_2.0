...
For this project, I’ll design the tables to hold the data from the CSV files, import the CSV files into a SQL database, and then answer questions about the data. I'll then erform data modeling, data engineering, and data analysis, respectively.
